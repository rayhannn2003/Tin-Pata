  ...
  return (
    <SafeAreaView style={[styles.root, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      <View style={styles.content}>
        <ThemedText secondary>{t('auth.signUpSubtitle')}</ThemedText>
        <ThemedText variant="caption" secondary>
          {t('auth.profileAutoCreated')}
        </ThemedText>
        ...
        {loading ? (
          ...
          <Button label={t('auth.signUp')} onPress={() => void handleSignUp()} disabled={!isConfigured} />
        )}
